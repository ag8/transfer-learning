...
def main(_):
    ...
    mmnist = load_mmnist(cfg.dataset_ld + str(num_examples))  # Load the entire MMNIST this time
    ...
    # For output data
    f1 = open('out_caps_test_ld' + str(num_examples) + '.csv', 'w+', 0)
    ...
    saver.restore(sess, "/mas/u/mkkr/andrewg/transfer-learning/capsnet_real/saved_state/model13409.ckpt")
