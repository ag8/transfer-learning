...
def main(_):
    ...
    mmnist = load_mmnist(cfg.dataset_full)  # Load the entire MMNIST this time
    ...
    # For output data
    f1 = open('out_caps_test_on_full_.csv', 'w+', 0)
    ...
    saver.restore(sess, "/home/urops/andrewg/transfer-learning/capsnet_real/saved_state/model13409.ckpt")
