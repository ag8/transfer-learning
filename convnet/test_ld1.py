...
def main(_):
    ...
    mmnist = load_mmnist(cfg.dataset_ld + str(num_examples))
    ...
    # For output data
    f1 = open('out_conv_test_ld' + str(num_examples) + '.csv', 'w+', 0)
    ...
    saver.restore(sess, "/mas/u/mkkr/andrewg/transfer-learning/convnet/saved_state/model51609.ckpt")
